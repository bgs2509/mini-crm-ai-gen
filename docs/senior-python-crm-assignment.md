...
### 7. Activity (таймлайн активности по сделке)
- id
- deal_id
...
2. **Воронка продаж** (`/analytics/deals/funnel`):
...
- В репо:
  ...
  - README.md с:
    ...
    - инструкцией запуска,
    - примерами API-запросов (опционально).
